...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">      
    ...
    <li class="nav-item"><a class="nav-link" href="../tickets/tickets.php">Εισητήρια-Κάρτες</a></li>
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Επεξεργασία προφίλ</li>
  </ol>
</nav>    
                ...
                <hr>
                  <form class="form" action="##" method="post" id="registrationForm">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              <label for="password"><h4>Κωδικός</h4></label>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                            <label for="password2"><h4>Επιβεβαίωση κωδικού</h4></label>

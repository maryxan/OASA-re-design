    ...
    echo '<footer class="site-footer">
        <div class="row" style="margin-left:20px;">
            ...
            <div class="col-sm-12 col-md-6">
                <h6>Για τον ΟΑΣΑ</h6>
                <p class="text-justify">Ο Οργανισμός Αστικών Συγκοινωνιών Αθηνών αποτελεί το δίκτυο των αστικών συγκοινωνιών στο λεκανοπέδιο Αττικής, παρέχει ενοποιημένες συγκοινωνιακές υπηρεσίες με 5 συγκοινωνιακά μέσα (λεωφορεία, μετρό, ηλεκτρικό, τρόλλεϋ και τραμ) και προωθεί τη βιώσιμη αστική κινητικότητα. Eίναι ο μεγαλύτερος φορέας συγκοινωνιακού έργου στην Ελλάδα, υπεύθυνος για τον έλεγχο και την λειτουργία των μέσων μαζικής μεταφοράς της Αθήνας, αλλά και της ευρύτερης Μητροπολιτικής περιοχής αυτής.</p>
            </div>
